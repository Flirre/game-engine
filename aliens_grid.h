...
//
//	ObjectPool<Koopa> * aliens_pool;
//	ObjectPool<Bomb> * bombs_pool;
//
//public:
//	virtual ~AliensGridBehaviourComponent() {}
//
//	virtual void Create(AvancezLib* system, GameObject * go, std::set<GameObject*> * game_objects, ObjectPool<Koopa> * aliens_pool, ObjectPool<Bomb> * bombs_pool)
//	{
...
//		//	for (auto j = 0; j < 2; j++)
//		//	{
//		//		Koopa * alien = aliens_pool->FirstAvailable();
...
//			if (bomb != NULL)
//			{
//				Koopa * alien = aliens_pool->SelectRandom();
//				if (alien != NULL)
//				{
